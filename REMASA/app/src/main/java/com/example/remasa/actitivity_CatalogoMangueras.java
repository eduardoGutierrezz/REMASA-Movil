...
public class actitivity_CatalogoMangueras extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actitivity_catalogo_mangueras);
        ...
        iVBanner = findViewById(R.id.iVBannerCatalogo);
