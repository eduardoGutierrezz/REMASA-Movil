...
public class activity_SurtidorEntregaEnSucursal extends AppCompatActivity {

    ImageButton btnHome, btnCatalogo, btnPedidosFinalizados, btnPedidosEnProceso, btnNuevosPedidos, btnCuenta;
    ImageView iVBanner;
    TextView tVProducto, tVCodigo, tVPrecioPza, tVTotal, tVNombre, tVNombres, tVNumPedido, tVidPedido, tVTelefonos, tVTel, tVTotalFinal, tVMxn;
    ListView lVPedidos;
    EditText eTTotal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surtidor_entrega_en_sucursal);
        ...
        btnCancelarPedido.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(activity_SurtidorEntregaEnSucursal.this, "Pedido cancelado", Toast.LENGTH_LONG).show();
            }
        });
        //------------------------------------------------------------------------------------------
        btnPagado.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(activity_SurtidorEntregaEnSucursal.this, "Pedido pagado",Toast.LENGTH_LONG).show();
            }
        });
    }
}