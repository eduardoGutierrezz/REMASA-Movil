...
public class AdapterInventario extends FirestoreRecyclerAdapter<Producto, AdapterInventario.ViewHolder> {
    ...
    public AdapterInventario(@NonNull FirestoreRecyclerOptions<Producto> options, Activity activity, FragmentManager fm) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull AdapterInventario.ViewHolder viewHolder, int i, @NonNull Producto producto) {
